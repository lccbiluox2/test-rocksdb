...
public class GettingStartDemo {
    ...
    /**
     * 测试点：https://www.cnblogs.com/ilovezihan/archive/2020/02/03/12258133.html
     *
     * 测试结果：
     *
     * 写入数据到RocksDB完成！
     * 从RocksDB读取key = zhangsan的value为20
     *
     * @param args
    ...
    public static void main(String[] args) throws RocksDBException {
        ...
        RocksDB rdb = RocksDB.open(dbOpt, "/Users/lcc/IdeaProjects/lcc_work/test-rocksdb/rocksdb-v511-api-demo/src/main/resources/data/rocksdb");
